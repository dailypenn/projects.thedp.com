var people = {
  ...
  "ua": {
    ...
    "SAS_Representative": [{
      ...
      {
        'name': 'Ben May',
        'photo': 'https://snworksceo.imgix.net/dpn/828a0122-72ff-4619-9f6e-f8767b44d012.sized-1000x1000.JPG?h=400',
        'statement': "Hello, I’m Ben May. As an elected member for the past two years, I have been devoted towards promoting campus sustainability, improving mental wellness at Penn, increasing civic engagement by students, and making the UA more transparent. This past year, I served as the Sustainability and Community Impact Committee Director. In this role, I authored and passed with an overwhelming majority a resolution endorsing divestment from the coal and tar sands industries. Furthermore, I oversaw projects focused on promoting campus composting, recycling, and infrastructure renovations. I pressed for increased sustainability on campus by facilitating discussion on environmental topics, elevating the level of communication between the UA and the environmental community, and meetings with Penn administrators. My work on sustainability on and off campus earned me the distinction of Global 30 Under 30 for Environmental Education. Aside from sustainability, I promoted student engagement in Philadelphia and participation in elections. To increase UA transparency, I facilitated the creation of summaries for each UA GBM along with publicizing a google form to provide problems you want solved directly to the UA. I worked towards making it easier to audit courses and preventing classes from becoming overbooked (let’s agree, the floor does not count as a desk). Next year, I hope to build upon my previous efforts, make GBM summaries a precedent for future years, and work to improve Penn mental health facilities. Vote Ben May for UA!",
        'endorsements': ''
      },
      {
        'name': 'Carmen Duran',
...
window.onload = function() {
  ...
  function loadList(people, listID) {
    ...
    for (var i in people) {
      ...
      candidate.innerHTML = "<div class = 'image' style = 'background-image: url(" + people[i].photo +")'></div>"
        +"<h3>" + people[i].name + "</h3>" +
        "<p>" +
