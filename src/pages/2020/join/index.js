...
const SportsImage = "linear-gradient(rgba(170, 30, 34, 0.9), rgba(170, 30, 34, 0.9)), url('https://snworksceo.imgix.net/dpn/cec0e468-8fd7-4820-906d-9981ae887347.sized-1000x1000.jpg')"
...
const Join = () => {
  ...
  return (
    <>
      ...
      <Wrapper background={editorialImage}>
        <header>
        ...
        <section class="editorial">
          ...
          <div class="section">
            ...
            <div class="departments">
              ...
              <span><h4 class="ed-tab" id="sports" onClick={() => setEditorialImage(SportsImage)}>Sports</h4></span>
