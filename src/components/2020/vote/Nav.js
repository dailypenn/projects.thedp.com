    ...
    >
      <div className="navbar-collapse w-100 dual-collapse2 order-1 order-md-0 collapse">
        <LeftUL className="navbar-nav ml-auto text-center">
          <li className="nav-item active">
            <Link className="nav-link" to="#explainers"> <NavText> Explainers </NavText></Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link" to="#inOtherNews"> <NavText> In Other News</NavText> </Link>
          </li>
          <li className="nav-item">
      ...
      <div className="navbar-collapse w-100 dual-collapse2 order-2 order-md-2 collapse">
        <RightUL className="navbar-nav mr-auto text-center">
          ...
          <li className="nav-item">
            <Link className="nav-link" to="#multimedia"> <NavText> Multimedia </NavText> </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link" to="#utb"> <NavText> Under The Button </NavText></Link>
          </li>
        </RightUL>
      </div>
    </nav>
