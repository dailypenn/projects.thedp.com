  ...
  <div className="col-md-4">
    <ExplainWrapper>
      <StyledAnchor href={article.link} target="_blank">
        ...
        <RedSectionHeader style={{ textAlign: "center", marginTop: "2rem" }}>
          {" "}
          EXPLAINER{" "}
        </RedSectionHeader>
        <ArticleHeader style={{ textAlign: "center", marginTop: "1rem" }}>
          {" "}
          {article.title}{" "}
        </ArticleHeader>
        <ArticleDescription style={{ textAlign: "center", marginTop: "1rem" }}>
          {" "}
          {article.description}{" "}
        </ArticleDescription>
        <ArticleAuthor style={{ textAlign: "center", marginTop: "1rem" }}>
          {" "}
          BY {article.author}{" "}
        </ArticleAuthor>
      </StyledAnchor>
...
const Feature = ({ article }) => (
  <div className="col-md-8">
    <BackgroundImage
      fluid={article.img.src.childImageSharp.fluid}
      style={{ border: "none" }}
    >
      <StyledAnchor href={article.link} target="_blank">
        <FeatureText>
          <RedSectionHeader style={{ color: "white" }}>
            {" "}
            EXPLAINER{" "}
          </RedSectionHeader>
    ...
    <div className="row" style={{ marginTop: "4rem" }}>
      <div className="col-md-4 pl-0">
        <NewText>
          ...
          <ArticleHeader style={{ fontSize: "2.5rem" }}>
            {" "}
            {article.title}{" "}
          </ArticleHeader>
      ...
      <div className="col-md-8">
        <iframe
          src="https://flo.uri.sh/visualisation/3639321/embed"
        ...
        <div style={{ width: "100%", marginTop: "4px" }}>
          <a
            ...
            href="https://public.flourish.studio/visualisation/3639321/?utm_source=embed&utm_campaign=visualisation/3639321"
            target="_top"
          >
            <img
...
const ExplainItToMe = () => (
  <StaticQuery
    query={graphql`
      query {
        allFile(
          filter: { relativePath: { eq: "vote_2020_ExplainItToMe.json" } }
        ) {
          edges {
            node {
    ...
    render={data => {
      const {
        node: { childrenVote2020ExplainItToMeJson: articles },
