        ...
        <div className="row">
          <div className="col-md-6 right-border narrow-col-right">
            <img
              alt=""
              className="img-fluid"
              src="https://s3.amazonaws.com/snwceomedia/dpn/f880ab9e-bc8a-4f3d-a44b-541a31e6c13c.sized-1000x1000.jpg"
            />
            <MainHeader>
              College admissions scandal hits Penn men’s basketball
            </MainHeader>
            <SectionMainText>
              Former Penn men’s basketball coach Jerome Allen has remained a key
              witness for the investigation into the college admissions bribery
              scandal that came to light in March 2019. He plead guilty in
              October 2018 to accepting bribes in exchange for recruitment of a
              player. In March, Allen testified in a federal trial that Philip
              Esformes paid him to facilitate his son’s recruitment in 2015.
              Although the national scandal that broke days after Allen's
              testimony did not name Penn, Dean of Admissions Eric Furda said
              Penn would consider revising its recruitment process. During
              Esformes' trial, news broke that he had also sent more than
              $400,000 to the consultant at the center of the national scandal
              after contacting him about his son’s recruitment. Esformes’ trial
              ended in April when he was found guilty on 20 charges, including
              bribery. In July, a judge sentenced Allen to four years probation,
              community service, and a fine, avoiding jail time. The next day,
              Penn Athletics removed Allen from its Hall of Fame.
            </SectionMainText>
          </div>
          <div className="col-md-6 narrow-col-left">
            <div className="row">
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 right-border-inverse narrow-col-right">
            ...
            />
            <MainHeader inverse>
              Penn Design and Penn Law renamed after large donations
            </MainHeader>
            <SectionMainText inverse>
              Penn renamed two of their twelve schools this year after receiving
              large donations. In February, Penn’s School of Design was renamed
              the University of Pennsylvania Stuart Weitzman School of Design
              after the fashion icon and 1963 Wharton alumnus. Students voiced
              anger over the renaming, arguing that Weitzman’s career as a
              designer has no relation to any academic program at Penn. Students
              added administrators should have considered student input before
              the decision. In November, the University renamed Penn Law School
              to the University of Pennsylvania Carey Law School after the
              largest donation to any law school. A petition demanding the
              school change its short-form name from “Carey Law” back to “Penn
              Law” garnered over 500 signatures from students and alumni within
              two days of the announcement. Ten days after the initial
              announcement of the name change, Penn Law Dean Ted Ruger announced
              the school will change its short-form name back to “Penn Law”
              after widespread backlash from students and alumni.
            </SectionMainText>
          </div>
          <div className="col-md-6 narrow-col-left">
            <div className="row">
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 right-border narrow-col-right">
            ...
            />
            <MainHeader>
              Students demand University to reprimand Wax for “racist”
              statements
            </MainHeader>
            <SectionMainText>
              Penn Law professor Amy Wax sparked controversy again this summer
              after claiming that the United States would be “better off with
              more whites and fewer nonwhites.” Her comments prompted student
              activism through marching protests and petitions calling for the
              University to relieve her of all teaching duties. In October, the
              Undergraduate Assembly passed a resolution demanding the
              administration fire Wax. Wax previously caused controversy in 2017
              when she claimed that white, Anglo-Saxon cultural norms are
              superior, and that she had never seen a black Penn Law student
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 right-border-inverse narrow-col-right">
            ...
            />
            <MainHeader inverse>
              Students pressure University to address the climate crisis
            </MainHeader>
            <SectionMainText inverse>
              Pressure mounted this semester from students opposing Penn’s
              investment in the fossil fuel industry. In light of Penn's Board
              of Trustees' refusal to review Fossil Free Penn’s most recent
              divestment proposal last year, leaders said the club had no choice
              but to rethink its strategy and engage in direct action. FFP began
              holding weekly sit-ins outside of Penn President Amy Gutmann’s
              office in September. Weeks after the first sit-in, the University
              announced a Climate Action Plan 3.0, outlining more incremental
              steps to reduce Penn’s carbon emissions. Some student climate
              activists criticized the plan for its vagueness and potential harm
              to disadvantaged Philadelphia communities. In November, FFP
              protested at Penn’s annual Board of Trustees meeting, ultimately
              shutting the meeting down. Student protesters aim to pressure Penn
              to host a climate town hall, with Chief Investment Officer Peter
              Ammon, Chair of the Board of Trustees David Cohen, and Gutmann all
              in attendance.
            </SectionMainText>
          </div>
          <div className="col-md-6 narrow-col-left">
          ...
          <div className="row">
            <div className="col-md-6">
              <a href="https://www.thedp.com/article/2019/09/climate-change-strike-philadelphia-philly-penn-protest-march-photo-gallery">
                <PhotoGallery
                  className="img-fluid"
                  src="https://snworksceo.imgix.net/dpn/708b89e3-630c-477b-bc3a-5d05932b1427.original.jpg"
                />
                <PrimaryStory inverse>
                  Highlights from the 2019 Philadelphia Climate Strike
                </PrimaryStory>
              </a>
            </div>
            <div className="col-md-6">
              <a href="https://www.thedp.com/article/2019/11/photo-essay-fossil-free-penn-board-of-trustees-meeting">
                <PhotoGallery
                  className="img-fluid"
                  src="https://snworksceo.imgix.net/dpn/0c0aae5d-a26c-4fbb-8693-c2abc211ab2b.original.jpg"
                />
                <PrimaryStory inverse>
                  The Fossil Free Penn protest that shut down Board of Trustees
                  meeting
                </PrimaryStory>
              </a>
            </div>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 right-border narrow-col-right">
            ...
            />
            <MainHeader>
              Two former Penn professors launch presidential campaigns
            </MainHeader>
            <SectionMainText>
              Two of the front-runners for the Democratic presidential
              nomination have served as Penn professors – former United States
              Vice President Joe Biden and current U.S. Senator Elizabeth Warren
              (D-Mass.). The two candidates launched their campaigns earlier
              this year, aiming to win in 2020 against incumbent President
              Donald Trump in 2020 — a 1968 Wharton graduate. Penn President Amy
              Gutmann announced on Feb. 7, 2017 that Biden would serve as a
              Benjamin Franklin Presidential Practice Professor and lead the
              Penn Biden Center for Diplomacy and Global Engagement. Warren
              taught contract and bankruptcy law at the University of
              Pennsylvania Carey Law School from 1987 to 1995, when she left to
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 right-border-inverse narrow-col-right">
            ...
            <SectionMainText inverse>
              Penn announced plans to create a slate of new buildings this year
              and continued constructing its record-breaking $163 million dorm
              New College House West, shaping up major changes to campus.
              Additionally, Penn continued construction of the Pavilion at the
              Hospital of the University of Pennsylvania, Tangen Hall, and the
              Wharton Academic Research Building. Residents living near
              construction zones criticized the noise, claiming they were
              frequently woken up by construction early in the morning. Students
              said they felt their concerns were largely unaddressed by
              administrators. Penn's construction of NCHW will provide more room
              to house students once sophomores will be required to live on
              campus in 2021. Students who criticized the sophomore housing
              policy voiced concerns about the costs of on-campus housing and
              its impact on Greek Life.
            </SectionMainText>
          </div>
          <div className="col-md-6 narrow-col-left">
            <div className="row">
