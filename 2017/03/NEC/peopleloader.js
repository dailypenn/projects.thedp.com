...
$(document).ready(function() {
  ...
  loadList(cb18["President"], "ua-18-list");
  loadList(cb18["Executive_Vice_President"], "ua-18-vp-list");
  loadList(cb18["College_Chair"], "ua-18-sas-rep");
  loadList(cb18["Engineering_Chair"], "ua-18-seas-rep");
  loadList(cb18["Wharton_Chair"], "ua-18-wharton-rep");
  loadList(cb18["Nursing_Chair"], "ua-18-nurs-rep");
  loadList(cb18["Vice_president_of_External_Affairs"], "ua-18-vp-ext");
  loadList(cb18["Vice_president_of_Finances"], "ua-18-vp-fin");
  loadList(cb18["Vice_president_of_Internal_Affairs"], "ua-18-vp-int");
  ...
  loadList(cb19["Vice_president_of_Finances"], "ua-19-vp-fin");
